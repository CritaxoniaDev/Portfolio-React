...
function Home({ isDarkMode }) {
    ...
    return (
        <section id="home" className={`min-h-screen flex items-center justify-center ${isDarkMode ? 'bg-gray-900 dark-mode-bg' : 'bg-gradient-to-br from-indigo-50 to-blue-100'} overflow-hidden relative animate-fade-in`}>
            <ParticleBackground />
            ...
            <div className={`max-w-7xl mx-auto px-8 pt-20 sm:px-10 lg:px-12 flex ${isMobile ? 'flex-col' : 'flex-row'} items-center relative z-10 animate-fade-in`} style={{ animationDelay: '0.8s' }}>
                <div className={`${isMobile ? 'hidden' : 'flex flex-col items-center mr-8'}`}>
                ...
                <div className={`${isMobile ? 'w-full' : 'md:w-1/2'} flex flex-col items-start animate-fade-in`} style={{ animationDelay: '1s' }}>
                    <h1 className={`font-extrabold mb-4 text-transparent bg-clip-text bg-gradient-to-r ${isDarkMode ? 'from-white to-blue-400' : 'from-black to-blue-500'} ${isMobile ? 'text-4xl' : 'text-5xl'}`}>
                        ...
                        <span className={`relative pt-3 ${isMobile ? 'text-4xl' : 'text-6xl'} inline-block color-cycle`}>
                            Gian Raphael D. Alcantara
                        </span>
                    </h1>
                    ...
                    <div
                        ref={skillRef}
                        className={`${isMobile ? 'text-2xl' : 'text-3xl'} font-bold ${isDarkMode ? 'text-indigo-400' : 'text-indigo-600'} ${isMobile ? 'h-8' : 'h-10'} mb-4 overflow-hidden whitespace-nowrap`}
                    ></div>
                ...
                <div className={`${isMobile ? 'w-full mt-12' : 'md:w-1/2 mt-0'} relative animate-fade-in`} style={{ animationDelay: '1.2s' }}>
